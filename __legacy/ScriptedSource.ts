...
import { Uint256, IMessage } from '../src/types';
import { asyncDelay, asyncTimer } from '../src/utils';
import { AscComparator } from '../src/messages-list/types';
import { LowLevelMessagesSource } from '../src/messages-list/types/LowLevelMessagesSource';
...
export class ScriptedSource extends EventEmitter implements LowLevelMessagesSource {
