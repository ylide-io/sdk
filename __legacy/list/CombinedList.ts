...
import { ExtendedDoublyLinkedList } from '../../src/common/ExtendedDoublyLinkedList';
import { ExecutionQueue, ExecutionState, IExecutionFuture } from '../../src/messages-list/types/ExecutionQueue';
...
export class CombinedList<T, S extends GenericSortedSource<T>> extends EventEmitter {
	...
	private list = new ExtendedDoublyLinkedList<GenericEntry<T, S>>();
