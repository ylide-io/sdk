...
export function isUint256(t: any): t is Uint256 {
...
export function uint8ArrayToUint256(a: Uint8Array): Uint256 {
	if (a.length !== 32) {
		throw new Error('Not convertable');
	}
...
export function bigIntToUint256(a: string): Uint256 {
...
export function uint256ToHex(val: Uint256): string {
	return val;
}

export function uint256ToUint8Array(val: Uint256) {
